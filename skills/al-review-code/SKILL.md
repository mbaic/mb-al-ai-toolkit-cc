...
If a file path is provided, read the file content, extract procedures, and review them.

If a folder path is provided, list `.al` files, read each, and review every procedure found.
